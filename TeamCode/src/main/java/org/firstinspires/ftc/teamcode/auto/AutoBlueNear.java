    ...
    public void start() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_PRE_1, BLUE_NER_INTAKE_1, 0.5),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_PRE_2, BLUE_NER_INTAKE_2, 0.5),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        new InstantCommand(() -> robot.shooter.setTriggerServo()),
                        new WaitCommand(200),
                        ...
                        // 发射第二组球
                        new InstantCommand(() -> robot.shooter.setShooterVelocity(SHOOT_VELOCITY_NER_1)),
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_2, BLUE_NER_SHOOT_2),
                        new InstantCommand(() -> robot.shooter.triggerPut()),
                        new WaitCommand(200),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        new WaitCommand(200),
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_PRE_3, BLUE_NER_INTAKE_3, 0.5),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        new InstantCommand(() -> robot.shooter.setTriggerServo()),
                        new WaitCommand(200),

                        // 发射第三组球
                        new InstantCommand(() -> robot.shooter.setShooterVelocity(SHOOT_VELOCITY_NER_2)),
                        new InstantCommand(() -> robot.shooter.panelTo(PANEL_NER_2)),
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_3, BLUE_NER_SHOOT_3),
                        new InstantCommand(() -> robot.shooter.triggerPut()),
                        new WaitCommand(200),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        new WaitCommand(200),
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_SHOOT_3, BLUE_NER_PARK),
