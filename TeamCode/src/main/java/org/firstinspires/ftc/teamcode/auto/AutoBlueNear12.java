...
public class AutoBlueNear12 extends OpMode {
    ...
    public void start() {
        ...
        autoEndX = BLUE_NER_PARK.getX();
        autoEndY = BLUE_NER_PARK.getPose().getY();
        autoEndH = BLUE_NER_PARK.getHeading();
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_1, BLUE_NER_GATE_MID_2, BLUE_NER_GATE_2),
                        new WaitCommand(300),
                        new InstantCommand(() -> robot.intake.intakeInAuto()),

                        // 发射第一组球
                        new DrivePointToPoint(follower, BLUE_NER_GATE_2, BLUE_NER_SHOOT_1),
                        ...
                        // 开闸
                        new InstantCommand(() -> robot.intake.intakeStop()),
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_2, BLUE_NER_GATE_MID_1, BLUE_NER_GATE_1),
                        new WaitCommand(300),
                        new InstantCommand(() -> robot.intake.intakeInAuto()),

                        // 发射第二组球
                        new DrivePointToPoint(follower, BLUE_NER_GATE_1, BLUE_NER_SHOOT_2),
                        new InstantCommand(() -> robot.shooter.openGate()),
                        new WaitCommand(100),
                        new InstantCommand(() -> robot.shooter.triggerFire()),
                        new WaitCommand(900),
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_PRE_3, BLUE_NER_INTAKE_3, 0.6),
                        new InstantCommand(() -> robot.shooter.triggerHold()),
                        ...
                        new InstantCommand(() -> robot.intake.intakeStop()),
                        new DrivePointToPoint(follower, BLUE_NER_SHOOT_2, BLUE_NER_PARK).setHoldEnd(true),
