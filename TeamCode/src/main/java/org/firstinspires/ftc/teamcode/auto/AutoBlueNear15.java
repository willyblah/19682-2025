    ...
    public void start() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        // 发射第二组球
                        new DrivePointToPoint(follower, BLUE_NER_INTAKE_2, BLUE_NER_GATE_MID_1, BLUE_NER_SHOOT_2),
                        new InstantCommand(() -> robot.shooter.openGate()),
                        new WaitCommand(100),
                        new InstantCommand(() -> robot.shooter.triggerFire()),
                        new WaitCommand(850),
                        ...
                        new DrivePointToPoint(follower, BLUE_NER_SHOOT_2, BLUE_NER_GATE_1),
                        new WaitCommand(200),
                        new InstantCommand(() -> robot.intake.intakeInAuto()),
                        new InstantCommand(() -> robot.shooter.triggerSlow()),
                        new DrivePointToPoint(follower, BLUE_NER_GATE_1, BLUE_NER_SUCK_MID, BLUE_NER_SUCK_1),
                        new WaitCommand(300),
