...
public class AutoRedFar9 extends OpMode {
    ...
    public void start() {
        ...
        autoEndX = RED_FAR_PARK.getX();
        autoEndY = RED_FAR_PARK.getPose().getY();
        autoEndH = RED_FAR_PARK.getHeading();
...
//                        ),
                        ...
                        new InstantCommand(() -> robot.shooter.triggerSlow()),
                        new DrivePointToPoint(follower, RED_FAR_SHOOT, RED_FAR_SUCK),
                        new WaitCommand(4000),
                        new InstantCommand(() -> robot.shooter.triggerHold()),

                        new DrivePointToPoint(follower, RED_FAR_SUCK, RED_FAR_SHOOT),
                        new InstantCommand(() -> robot.shooter.openGate()),
                        new WaitCommand(100),
                        new InstantCommand(() -> robot.shooter.triggerFireFar()),
                        new WaitCommand(180),
