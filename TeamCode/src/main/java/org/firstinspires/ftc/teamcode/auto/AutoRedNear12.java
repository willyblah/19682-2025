...
public class AutoRedNear12 extends OpMode {
    ...
    public void start() {
        ...
        autoEndX = RED_NER_PARK.getX();
        autoEndY = RED_NER_PARK.getPose().getY();
        autoEndH = RED_NER_PARK.getHeading();
        teleOpTargetX = teleOpTargetXR;
        teleOpTargetY = teleOpTargetYR;
        teleOpRev = Boolean.FALSE;
        MANUAL_POS = RED_MANUAL_POS;
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new DrivePointToPoint(follower, RED_NER_INTAKE_1, RED_NER_GATE_MID_2, RED_NER_GATE_2),
                        new WaitCommand(300),
                        new InstantCommand(() -> robot.intake.intakeInAuto()),

                        // 发射第一组球
                        new DrivePointToPoint(follower, RED_NER_GATE_2, RED_NER_SHOOT_1),
                        ...
                        // 开闸
                        new InstantCommand(() -> robot.intake.intakeStop()),
                        new DrivePointToPoint(follower, RED_NER_INTAKE_2, RED_NER_GATE_MID_1, RED_NER_GATE_1),
                        new WaitCommand(300),
                        new InstantCommand(() -> robot.intake.intakeInAuto()),

                        // 发射第二组球
                        new DrivePointToPoint(follower, RED_NER_GATE_1, RED_NER_SHOOT_2),
                        new InstantCommand(() -> robot.shooter.openGate()),
                        new WaitCommand(100),
                        new InstantCommand(() -> robot.shooter.triggerFire()),
                        new WaitCommand(900),
                        ...
                        new InstantCommand(() -> robot.intake.intakeStop()),
                        new DrivePointToPoint(follower, RED_NER_SHOOT_2, RED_NER_PARK).setHoldEnd(true),
